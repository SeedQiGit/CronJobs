/*
 ...
 Source Schema         : cron_job

 Target Server Type    : MySQL
 Target Server Version : 80012
 File Encoding         : 65001

 Date: 26/07/2020 22:11:43
*/
...
-- ----------------------------
INSERT INTO `__efmigrationshistory` VALUES ('20200315124504_first', '3.1.2');
...
CREATE TABLE `cron_job`  (
  ...
  `Description` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `CronExpress` varchar(400) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `JobState` bigint(20) NOT NULL DEFAULT 0,
  `RequestUrl` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
...
-- Records of cron_job
-- ----------------------------
INSERT INTO `cron_job` VALUES (4, '2020-03-27 10:26:44', 11, '2020-04-15 15:33:42', 11, 'tttt', 'test', '0/10 * * * * ?', 1, 'www.baidu.com');
