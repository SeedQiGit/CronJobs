...
namespace Infrastructure.Model.Response
{
    public class BaseResponse
    {
        ...
        {
            Code = (int)code;
            Message = EnumHelper.GetEnumDescription(code);
        }
        ...
        public static BaseResponse Failed(string message = null)
        {
            ...
            return GetBaseResponse(code, message ?? EnumHelper.GetEnumDescription(code));
        }
    ...
    public class BaseResponse<T> : BaseResponse
    {
        ...
        {
            return new BaseResponse<T>((int)code, EnumHelper.GetEnumDescription(code), data);
        }
